...
# Count the number of app categories using set() or unique() function
...
# Filter rows where both 'Rating' and 'Size' values are present (not null)
...
# Load user_reviews.csv into the reviews_df DataFrame
reviews_df = pd.read_csv('datasets/user_reviews.csv')

# Merge apps and reviews_df DataFrames
